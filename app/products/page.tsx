		...
		<article>
			<div className="max-w-7xl mx-auto px-6">
				<h2 className="text-2xl font-black md:text-3xl xl:text-4xl">
					ALL <br /> <span className="text-orange-200">PRODUCTS</span>
				</h2>
				<section className="flex flex-col gap-4 mt-4 max-w-3xl sm:mt-6 md:flex-row md:justify-between">
					<div>
						...
						<ul className="space-y-1 text-sm mt-2 lg:text-base lg:mt-4">
							<li className="hover:text-orange-200 duration-200 cursor-pointer">All</li>
							<li className="hover:text-orange-200 duration-200 cursor-pointer">Men</li>
							<li className="hover:text-orange-200 duration-200 cursor-pointer">Women</li>
							<li className="hover:text-orange-200 duration-200 cursor-pointer">Unisex</li>
						</ul>
					</div>
					<div>
