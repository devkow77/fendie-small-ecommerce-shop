...
const PaginationLink = ({ className = 'dark:bg-neutral-800 dark:hover:bg-neutral-700', isActive, size = 'icon', ...props }: PaginationLinkProps) => (
	<PaginationItem>
		<a
...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
	<PaginationLink aria-label="Go to previous page" size="default" className={cn('gap-1 pl-2.5 dark:bg-neutral-900 dark:hover:bg-transparent', className)} {...props}>
...
const PaginationNext = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
	<PaginationLink aria-label="Go to next page" size="default" className={cn('gap-1 pr-2.5 dark:bg-neutral-900 dark:hover:bg-transparent', className)} {...props}>
		<span>Next</span>
